...
class EdifyGenerator(object):
  ...
  def PrintPixelExperienceBanner(self, is_plus, android_version, flexo_version, build_id, build_date,
                                  security_patch, device):
    self.Print("----------------------------------------------")
    if is_plus:
      self.Print("        ProjectFlexo(Reboot)")
      self.Print("                by TeamFlexo")
    else:
      self.Print("              ProjectFlexo(Reboot)")
      self.Print("              by TeamFlexo")
    self.Print("----------------------------------------------")
    self.Print(" Android version: %s"%(android_version))
    self.Print(" ProjectFlexo version: %s"%(flexo_version))
